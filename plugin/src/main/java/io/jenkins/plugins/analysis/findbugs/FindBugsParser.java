package io.jenkins.plugins.analysis.findbugs; // NOPMD
...
public class FindBugsParser {
    ...
    private Issues<Issue> parse(final InputStream file, final Collection<String> sources,
        ...
        for (BugInstance warning : bugs) {
            ...
            builder.setFileName(findSourceFile(project, sourceFinder, sourceLine))
            ...
            // FIXME: setAffectedLines(warning, bug);

            issues.add(builder.build());

            // FIXME:  bug.intern(stringPool);
        }
